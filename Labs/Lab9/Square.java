...
public class Square extends Rectangle{ 
	...
	public Square(Color fillColor, Color borderColor, int x, int y, int xDirection, int yDirection, int height) {
		super(fillColor, borderColor, x, y, xDirection, yDirection, height, height);
		
	}
	
	//Second constructor case for set borderColor to Black since not provided 
	public Square(Color fillColor, int x, int y, int xDirection, int yDirection, int height) {
		super(fillColor, x, y, xDirection, yDirection, height, height);
	}
	
	//Third constructor case: set fillColor to white and border color to black 
	public Square(int x, int y, int xDirection, int yDirection, int height) {
		super(x, y, xDirection, yDirection, height, height);
	}
