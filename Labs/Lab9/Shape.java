 ...
 * Note X and Y are the top points of the shape
 */
...
abstract class Shape {
	...
	public Shape(Color fillColor, Color borderColor, int x, int y, int xDirection, int yDirection) {
	...
	public Shape(Color fillColor, int x, int y, int xDirection, int yDirection) { 
		this.fillColor = fillColor;
	...
	public Shape(int x, int y, int xDirection, int yDirection) { 
	...
	public void moveLocation() { 
		this.Location.translate(xDirection, yDirection);
	}
