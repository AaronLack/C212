	 ...
	 * Last edited: 2/21/20
	 * Creating a bread class with 4 instance variables: name, price, experationDate, and barcode.
...
public class Bread implements Scannable, Comparable {
	...
	public Bread(String name, double price, String experationDate, String barcode) {
		super();
		this.name = name;
		this.price = price;
	...
	public String toString() {
		return "Bread [name=" + name + ", price=" + price + ", experationDate=" + experationDate + ", barcode="
				+ barcode + "]";
	}
