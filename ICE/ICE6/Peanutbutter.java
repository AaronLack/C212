	 ...
	 * Last edited: 2/21/20
	 * Creating a peanutbutter class with 4 instance variables: name, price, experationDate, and barcode.
...
public class Peanutbutter implements Scannable, Comparable {
	...
	public Peanutbutter(String name, double price, String experationDate, String barcode) {
		super();
		this.name = name;
		this.price = price;
	...
	public String toString() {
		return "Peanutbutter [name=" + name + ", price=" + price + ", experationDate=" + experationDate + ", barcode="
				+ barcode + "]";
	}
